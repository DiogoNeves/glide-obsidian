...
5. Check collection-candidate files for obvious stale or irrelevant items, following the checklist.
6. Ask the user to confirm before making changes that could alter future behavior or require judgment.
7. Do not edit personal memory files except for allowed stale-item cleanup in collection-candidate files.
8. If the best fix would require changing the design principles, behavior, or personal data, report the issue and ask for approval.
