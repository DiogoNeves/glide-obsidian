...
Glide ships three starter automations:
...
- Codex: `adapters/codex/DAILY_GLIDE_CHECK_IN.md`, `adapters/codex/HARNESS_DRIFT_REVIEW.md`, and `adapters/codex/NIGHTLY_RESEARCH_REVIEW.md`
- Claude Code: `adapters/claude-code/DAILY_GLIDE_CHECK_IN.md`, `adapters/claude-code/HARNESS_DRIFT_REVIEW.md`, and `adapters/claude-code/NIGHTLY_RESEARCH_REVIEW.md`
- Generic: `adapters/generic/DAILY_GLIDE_CHECK_IN.md`, `adapters/generic/HARNESS_DRIFT_REVIEW.md`, and `adapters/generic/NIGHTLY_RESEARCH_REVIEW.md`
