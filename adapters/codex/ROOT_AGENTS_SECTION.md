...
- Glide skills live in `.agents/skills/` and are prefixed with `glide-`.
- `Agent HQ/User Profile.md` is the concise high-level user context; load it for personal advice, decisions, research, and daily check-ins.
...
- Glide itself does not collect data. Codex, models, connectors, sync, Git, and automations determine data exposure.
<!-- END GLIDE FOR OBSIDIAN -->
