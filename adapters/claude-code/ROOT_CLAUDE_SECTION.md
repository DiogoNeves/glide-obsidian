...
- Glide skills live in `.claude/skills/` and are prefixed with `glide-`.
...
- Glide itself does not collect data. Claude Code, models, connectors, sync, Git, and automations determine data exposure.
