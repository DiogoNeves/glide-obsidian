...
| --- | --- | --- | --- | --- | --- | --- |
| [[Automations/Daily Glide Check-In|Daily Glide Check-In]] | Proposed | Daily or weekdays | User profile, area reminders, open questions, active goals, ponders, areas, contradictions, action candidates | `glide-daily-check-in` calling `glide-update-user-profile` | Profile update pass, reminder scan, one useful touch, and light evaluation when useful | |
